...
@section('content')
    <h1 class="text-2xl font-bold mb-6">Nuevo proveedor</h1>

    <form method="POST" action="{{ route('suppliers.store') }}" class="bg-white rounded shadow p-6 max-w-2xl">
        @csrf
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="mb-4">
                ...
                <select id="document_type" name="document_type" required class="w-full rounded border border-gray-300 px-3 py-2">
                    <option value="NIT" @selected(old('document_type', 'NIT') === 'NIT')>NIT</option>
